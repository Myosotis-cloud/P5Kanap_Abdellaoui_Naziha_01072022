...
//     // si le panier est vide, on renvoi l'utilisateur à la page d'accueil de tous les produits
...
//     // fonction qui récupère les valeurs de nos inputs et l'id de chaque article dans un tableau "contact"
//     const body = preparationEnvoi ();
//     console.log (body);
//     validForm ();
